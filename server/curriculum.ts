...
const profiles:SkillProfile[]=[
  ...
  {id:'logic-puzzle-assembly',title:'Сборка пазла',subject:'logic',purpose:'Собирать целое из частей, удерживать расположение фрагментов и порядок слоёв.',parentMessage:'Пазл-задачи показывают, как ребёнок организует информацию и видит недостающие части.',childGoal:'Собрать картинку по правилу и объяснить, почему фрагмент подходит.',successCriteria:'3 из 4 пазлов без подсказки и с объяснением правила.',recommendedMinutes:7},
...
const aliases:[RegExp,string][]=[
  ...
  [/последователь|закономер/,'logic-sequence'],[/классифика|лишн/,'logic-classification'],[/аналог/,'logic-analogy'],[/пазл|фрагмент|құрастыр|бөлік/,'logic-puzzle-assembly'],
